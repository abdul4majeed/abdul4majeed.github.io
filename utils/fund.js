...
function create_developer_img_and_text() {
    ...
    text.innerHTML = `Hello World I am a solo developer and I live in small city 
                        ...
                        <br /> <p><img width='25px' src="`+image_path+'ethereum.png'+`" />  
                        ...
                        <span style="vertical-align: super;word-wrap: break-word;"><b>Bitcoin:</b> 3DCaSn1qJtLuUpQAaTBsVwVtMrwU87eaUU</span>
                        </p>`;
